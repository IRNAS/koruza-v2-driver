...
class Pca9554(object):
    def __init__(self, address):
        ...
        try:
            self.PORTS_COUNT = 4    # number of GPIO ports
            ...
            logging.error("No device found on address {}!".format(hex(address)))
            self.i2c_bus = None
        except:
            logging.error("Bus on channel {} is not available. Error raised by Pca9554.".format(I2C_CHANNEL))
